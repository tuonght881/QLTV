...
import com.QLTV.form.CaiDat;
import com.QLTV.form.Home_Form;
import com.QLTV.form.QuanLy;
import com.QLTV.form.QuanLyTheLoai;
    ...
    private void init() {
        ...
        menu.addEventMenu(new EventMenu() {
            ...
            public void selectedMenu(int index) {
                if (index == 0) {
                    mainBody.displayForm(new Home_Form(), "Thanh toán");
                }else if (index == 3) {
                    mainBody.displayForm(ql, "Quản lý");
                } else if (index == 5) {
    ...
    private void initComponents() {
        ...
        panelBackground1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBackground1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(mainBody, javax.swing.GroupLayout.DEFAULT_SIZE, 1002, Short.MAX_VALUE)
                .addContainerGap())
        );
