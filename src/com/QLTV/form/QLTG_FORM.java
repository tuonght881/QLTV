 ...
 * @author Tuong
 */
public class QLTG_FORM extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLTG_FORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
