 ...
 * @author Tuong
 */
public class THUESACH_FORM extends javax.swing.JFrame {
    ...
    public void setFormSach(Sach sach) throws ParseException {
        ...
        txt_manv.setText(sach.getIdsach());
        txt_ngay.setText(sach.getTensach());
    ...
    public Sach getFormSach() throws ParseException {
        ...
        sachNew.setIdsach(txt_manv.getText());
        sachNew.setTensach(txt_ngay.getText());
    ...
    public void loaddataSach() {
        ...
        modelTK.setColumnIdentifiers(new Object[]{"ID Sách", "Tên sách","Tác giả","Vị trí", "Số lượng", "Giá thuê", "Giá bán"});
        ...
        try {
            ...
            for (Sach sach : list) {
                ...
                TacGia tg = tgDAO.select_byID(sach.getIdtacgia());
                ViTri vt = vtDAO.select_byID(sach.getIdvitri());
                Object[] row = {sach.getIdsach(), sach.getTensach(), tg.getTentg(),vt.getTenvt(), sach.getSl(), currencyVN.format(sach.getGiathue1ngay()), currencyVN.format(sach.getGiaban())};
                modelTK.addRow(row);
            }
    ...
    public boolean batloi_tk() {
        String idsach = txt_manv.getText();
        String theloai = txt_theloai.getText();
        String tensach = txt_ngay.getText();
...
//                    }
    ...
    private void initComponents() {
        ...
        crazyPanel3.add(jTextField1);

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        jLabel7.setText("Tiền đảm bảo");
        crazyPanel3.add(jLabel7);

        jTextField2.setText("jTextField2");
        crazyPanel3.add(jTextField2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(THUESACH_FORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new THUESACH_FORM().setVisible(true);
            }
        });
    }
